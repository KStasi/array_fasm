...
macro sum_array array_ptr, len, sum_ptr {
    pusha
    local .loop1
    local .continue1
    xor ecx, ecx
    ...
    .loop1:
        ...
        jo .ret_error ; check if overflow ; OF=1 
        xor ax, ax

        lea ebx, [ebx + 2] ; point to next element
        jmp .loop1 ; go to next element
    .ret_error:
        exit 1
    .continue1:
...
start:
    ...
    sum_array array, [arr_len], sum ; calcculate sum
    print_num [sum] ; print result
    exit 0
    popa
    ret
